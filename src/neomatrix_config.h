...
// Teensy 3.0, 3.1/3.2, 3.5, 3.6
    ...
    //============================================================================================
        ...
        matrixLayer.addLayer(&scrollingLayer1); 
        ...
        show_callback();
        //matrixLayer.setRefreshRate(203);
        //scrollingLayer1.setRefreshRate(203);
        backgroundLayer.enableColorCorrection(true);


        scrollingLayer1.enableColorCorrection(true);
        scrollingLayer1.setMode(/*bounceForward*/wrapForward);
        scrollingLayer1.setColor({0, 96, 0});
        scrollingLayer1.setSpeed(60);
        scrollingLayer1.setFont(font3x5);
        scrollingLayer1.setOffsetFromTop((kMatrixHeight) - 5);
        scrollingLayer1.start("", 1);
        ...
        // Quick hello world test
            ...
            backgroundLayer.fillScreen( {0x0, 0x0, 0x0} );
            // backgroundLayer.swapBuffers();
            show_callback();
            delay(1000);
        #endif
